...
def createAccountOnNetwork(ta_service_base_url: str, machineId: str, plmnt_address: str, signature: str) -> requests.Response:
    # Define the URL and data
    url = ta_service_base_url + "/create-account"
    data = {
        "machine-id": machineId,
        "plmnt-address": plmnt_address,
        "signature": signature
    }
...
def attestMachine( plmnt_address: str, name: str, issuerPlanetmint: str, 
                  issuerLiquid: str, gps: str, deviceDefinition: str, machineID: str,
                  signature: str , additionalCID: str, chainID: str, 
                  accountID: int, sequence: int) -> str:
    ...
    attestMachine.machine.issuerPlanetmint = PlanetmintKeys.extended_planetmint_pubkey #"02328de87896b9cbb5101c335f40029e4be898988b470abbf683f1a0b318d73470"
    attestMachine.machine.issuerLiquid = PlanetmintKeys.extended_liquid_pubkey # "xpub661MyMwAqRbcEigRSGNjzqsUbkoxRHTDYXDQ6o5kq6EQTSYuXxwD5zNbEXFjCG3hDmYZqCE4HFtcPAi3V3MW9tTYwqzLDUt9BmHv7fPcWaB"
