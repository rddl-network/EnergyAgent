class DLMSFrame:
    ...
    DLMS_TYPES = {
        b'\xe0\x40': "Block Transfer",
        b'\xe0\xc0': "Final Block"
    }
    ...
    def _parse_frame(self):
        ...
        elif self.frame_bytes[current_pos:current_pos+2] in [b'\xe0\x40', b'\xe0\xc0']:  # Subsequent or final segment
            self.is_first_segment = False
            self.is_multi_segment = True
