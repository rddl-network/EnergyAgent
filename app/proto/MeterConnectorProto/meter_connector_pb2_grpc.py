...
def add_MeterConnectorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'MeterConnectorProto.MeterConnector', rpc_method_handlers)
...
class MeterConnector(object):
    ...
    def readMeter(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/MeterConnectorProto.MeterConnector/readMeter',
