...
def test_decode_packet_v2():
    ...
    encrypted_data = bytes.fromhex(
        ""
    )
...
def decrypt_message3(received_data, key, authentication_key):
    ...
    encrypted_message = bytes.fromhex(
        "DB084C475A67737C7EE0820103300001669A7654DA96C65E4930A6F3719E304F4BEBF8D6600508958B6CD46B16E8310B6868527C30EC8197FF9F80E7107AD7DB303072428E0C0F59FCBE2DFB07C6EDC5E1C4EB0A40DBF3E73ED8A52E65F3799F63A2341B345A940224ECDA0CEB215A6C7BAC19020D4468"
    )
    nonce = received_data[14:22] + received_data[24:28] + additive
